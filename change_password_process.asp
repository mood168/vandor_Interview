...
cmd.Parameters.Append cmd.CreateParameter("@CurrentPassword", 200, 1, 500, currentPassword)
...
cmd.Parameters.Append cmd.CreateParameter("@NewPassword", 200, 1, 500, newPassword)
